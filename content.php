...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="post-content">
		<?php if ( is_search() ) :
			...
			the_content( __( 'Read more... &raquo;', 'blogotron' ) );
			wp_link_pages( array(
				'before' => '<nav class="nav-post-page">' . __( 'Pages:', 'blogotron' ),
				'after'  => '</nav><!-- .nav-post-page -->',
			) );
		endif; // if ( is_search() ) ?>
	</div><!-- .post-content -->
		...
		<footer class="post-footer">
			<?php if ( $count > 1 || comments_open() ) : ?>
				<div class="post-bottom">
					<?php if ( $count > 1 ) : ?>
						<a class="scroll-top" href="#" title="Scroll to top"><?php _e( '[Top]', 'blogotron' ); ?></a>
					<?php endif; // if ( $count > 1 )
					if ( comments_open() ) : ?>
						<div class="comments-info">
							<?php comments_popup_link( __( '0 comments', 'blogotron' ) . ' &#187;', __( '1 comment', 'blogotron' ) . ' &#187;', sprintf( _n( '%1$s comment %2$s', '%1$s comments %2$s', get_comments_number(), 'blogotron' ), number_format_i18n( get_comments_number() ), '&#187;' ) ); ?>
						</div>
